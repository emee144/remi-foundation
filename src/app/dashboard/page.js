    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="bg-white shadow-md px-6 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex gap-6 text-gray-700 font-medium">
          ...
          <a href="/applications" className="flex items-center gap-1 hover:text-orange-500 transition">
            <ClipboardList className="w-5 h-5" /> Applications
          </a>
          <a href="/settings" className="flex items-center gap-1 hover:text-orange-500 transition">
